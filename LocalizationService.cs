...
public static class LocalizationService
{
    ...
    public static async Task ReadLocalizationFile(params string[] filePathes)
    {
        ...
        try
        {
            ...
            foreach (var filePath in pathesList)
            {
                ...
                var pack = JsonConvert.DeserializeObject<Dictionary<string, Dictionary<string, string>>>(reader.ReadToEnd());
